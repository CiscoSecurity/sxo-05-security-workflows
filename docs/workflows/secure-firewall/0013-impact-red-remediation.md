...
[<i class="fab fa-github"></i> GitHub]({{ site.github.repository_url }}/tree/Main/Workflows/0013-SecureFirewall-ImpactRedRemediation__definition_workflow_01M8YO6NV4TVT6c3JgFxA4BI7ZVhP3LToQK){: .btn-cisco-outline }
...
| Oct 31, 2022 | - Minor bug fix which could cause workflow failure if no observables were extracted from a sighting ([Issue #199]({{ site.github.repository_url }}/issues/199)) |
